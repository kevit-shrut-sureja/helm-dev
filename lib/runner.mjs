 ...
 * moment the service logged it rather than the moment devscope read the pipe.
...
export class ServiceRunner extends EventEmitter {
  ...
  /**
   * Checks whether a pid belongs to a service devscope started, so evidence about
  ...
  /**
   * Reports the pids devscope has signalled recently, so a process that has not
